	...
	<body>
		...
		<!-- Menu -->
         ...
         <section id="two" class="wrapper style1 special" style="margin-bottom: 2em">
                    <div class="inner">
                        <p>Other who have answered yes to the previous questions have found themselves in immediate danger, We recommend That you visit our resources page and seek specialist help.</p>
                        <center> 
                        <a href="#" class="button small" style="margin-top: 1em; margin-right: 4em; background-color: #25a2c3; ">Resources </a> 
                        <a href="incident_log.php" class="button small" style="margin-top: 1em; margin-right: 8em; background-color: #25a2c3; ">Assault Calender</a> 
                        </center>
                    </div>
