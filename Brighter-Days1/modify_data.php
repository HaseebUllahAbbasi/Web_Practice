		...
		<!-- Menu -->
         ...
         <section id="two" class="wrapper style1 special" style="margin: 3em; margin-bottom: 1em;">
             ...
             <section style="margin: 5em; margin-top: 2em;">
                 <form style="margin: 2em;" action="modify_resp.php"  method="post" enctype="multipart/form-data">
                        <di>
                     ...
                     <div style="">
                         <h1 >Description</h1>
                         <input style="width :30%" type="text" name="descrp" value="<?php  echo $row['description']; ?> " placeholder="Description"   />
                     </div>
                     <h1>Emotions</h1>    
                         <ul class="donate-now" style="">
                                <li>
